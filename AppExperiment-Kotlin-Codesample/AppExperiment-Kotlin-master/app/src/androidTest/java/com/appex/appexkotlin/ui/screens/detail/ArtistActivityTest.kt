...
import com.APPEx.APPExkotlin.ui.adapter.ArtistDetailPagerAdapter
import com.APPEx.APPExkotlin.ui.entity.ArtistDetail
...
class ArtistActivityTest : ActivityInstrumentationTestCase2<ArtistActivity>(ArtistActivity::class.java) {
    ...
    fun testViewPagerTitles() {
        // Given
        val desiredBioTitle = instrumentation.targetContext.getString(com.APPEx.APPExkotlin.R.string.bio_fragment_title)
        val desiredAlbumsTitle = instrumentation.targetContext.getString(com.APPEx.APPExkotlin.R.string.albums_fragment_title)
