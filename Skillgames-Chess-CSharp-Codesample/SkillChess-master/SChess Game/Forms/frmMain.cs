// --------------------------------------------------------------------------------------------------------------------
// <copyright file="frmMain.cs" company="SChess.com">
//   SChess.com
// </copyright>
// <summary>
...
namespace SChess
{
    ...
    public class frmMain : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.mnuAbout.Text = "&About SChess";
        ...
        private void LoadCursors()
        {
            ...
            if (strAsmName == "SChess2")
            {
                strAsmName = "SChess"; // Fix the assembly name with regard to the executable name
            }
        ...
        private void OpenGame()
        {
            ...
            openFileDialog.Filter = "SChess files (*.SChess)|*.SChess";
        ...
        private void SaveGame()
        {
            ...
            saveFileDialog.Filter = "SChess files (*.SChess)|*.SChess";
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            Game.BackupGamePath = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "BackupGame.SChess");
