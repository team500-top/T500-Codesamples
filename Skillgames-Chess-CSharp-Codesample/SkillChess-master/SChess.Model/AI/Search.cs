// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Search.cs" company="SChess.com">
//   SChess.com
// </copyright>
// <summary>
//   Performs the central move-selection logic for SChess, referred to as the Search. http://chessprogramming.wikispaces.com/Search
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace SChess.Model.AI
{
    ...
    public class Search
    {
            ...
            Player player, Moves principalVariation, int lastIterationsScore, Moves analysisParentBranch)
        {
            ...
            // TODO DISABLED: Investigate why aspiration is worse for SChess
