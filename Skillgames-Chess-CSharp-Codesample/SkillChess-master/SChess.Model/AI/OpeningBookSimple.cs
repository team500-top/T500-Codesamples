// --------------------------------------------------------------------------------------------------------------------
// <copyright file="OpeningBookSimple.cs" company="SChess.com">
//   SChess.com
// </copyright>
// <summary>
//   A small, in-memory, book of opening moves used simply to vary SChess's games against human. Not competition standard by any means!
...
namespace SChess.Model.AI
{
    ...
    /// <summary>
    /// A small, in-memory, book of opening moves, used simply to vary SChess's games against human players. Not competition standard by any means!
    ///   XML opening book files are created from PGN files using the <see cref = "PGNtoXML" /> class.
    /// </summary>
    public static class OpeningBookSimple
    {
        ...
        /// <summary>
        /// Converts the source opening bok into an XML format that SChess can processes.
        /// </summary>
        /// <returns>
