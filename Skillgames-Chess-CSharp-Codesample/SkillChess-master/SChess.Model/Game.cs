// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Game.cs" company="SChess.com">
//   SChess.com
// </copyright>
// <summary>
...
namespace SChess.Model
{
    ...
    public static class Game
    {
        ...
        static Game()
        {
            ...
            {
                RegistryKey registryKeySChess = registryKeySoftware.CreateSubKey(@"PeterHughes.org\SChess");

                if (registryKeySChess != null)
                {
                    if (registryKeySChess.GetValue("FileName") == null)
                    {
                        saveGameFileName = string.Empty;
                    }
                    else
                    {
                        saveGameFileName = registryKeySChess.GetValue("FileName").ToString();
                    }

                    if (registryKeySChess.GetValue("ShowThinking") == null)
                    {
                        ShowThinking = true;
                    }
                    else
                    {
                        ShowThinking = registryKeySChess.GetValue("ShowThinking").ToString() == "1";
                    }

                    // Delete deprecated values
                    if (registryKeySChess.GetValue("EnablePondering") != null)
                    {
                        registryKeySChess.DeleteValue("EnablePondering");
                    }

                    if (registryKeySChess.GetValue("DisplayMoveAnalysisTree") != null)
                    {
                        registryKeySChess.DeleteValue("DisplayMoveAnalysisTree");
                    }

                    if (registryKeySChess.GetValue("ClockMoves") != null)
                    {
                        registryKeySChess.DeleteValue("ClockMoves");
                    }

                    if (registryKeySChess.GetValue("ClockMinutes") != null)
                    {
                        registryKeySChess.DeleteValue("ClockMinutes");
                    }
                }
            }
...
*/
        ...
        public static void TerminateGame()
        {
            ...
            if (registryKeySoftware != null)
            {
                ...
                if (registryKeySChess != null)
                {
                    registryKeySChess.SetValue("FileName", saveGameFileName);
                    registryKeySChess.SetValue("ShowThinking", ShowThinking ? "1" : "0");
                }
            }
        }
        ...
        /// <summary>
        /// Enable or disable SChess's features
        /// </summary>
