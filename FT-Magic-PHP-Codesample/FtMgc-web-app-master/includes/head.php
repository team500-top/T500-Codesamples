...
<head>
    ...
    <!-- Custom ftmgc styles -->
    <link href="css/ftmgc-base.css?v=<?php echo CURRENT_VERSION; ?>" rel="stylesheet">
    <!--/build-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $().toastmessage('showToast', {
              sticky  : true,
              text    : 'App Update!<br />There is a critical update for the Windows application. Please update your app to the latest version:<br /> <a href="http://sourceforge.net/projects/ftmgc/files/latest/download?source=files" target="_blank" rel="external" style="word-wrap: break-word;">http://sourceforge.net/projects/ftmgc/files/latest/download?source=files</a>',
              type    : 'error',
              position: 'top-center'
            });
        });
