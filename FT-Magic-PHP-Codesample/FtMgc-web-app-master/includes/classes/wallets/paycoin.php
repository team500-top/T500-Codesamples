...
Sample Code FTMGC
 */
class Wallets_Paycoin extends Wallets_Abstract {

    public function __construct($label, $address) {
        parent::__construct($label, $address);
        $this->_apiURL = 'http://chainz.cryptoid.info/xpy/api.dws?q=getbalance&key=6e1508c63640&a=' . $address;
        $this->_fileHandler = new FileHandler('wallets/paycoin/' . $this->_address . '.json');
    }
