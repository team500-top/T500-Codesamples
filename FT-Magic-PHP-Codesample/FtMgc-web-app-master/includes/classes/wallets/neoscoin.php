...
Sample Code FTMGC
 */
class Wallets_Neoscoin extends Wallets_Abstract {

    public function __construct($label, $address) {
        parent::__construct($label, $address);
        $this->_apiURL = 'http://explorer.neoscoin.com:3000/chain/NeosCoin/q/addressbalance/' . $address;
        $this->_fileHandler = new FileHandler('wallets/neoscoin/' . $this->_address . '.json');
    }
