      ...
      <div class="navbar navbar-default navbar-fixed-top" role="navigation">
         <div class="container">
            <div class="navbar-header">
               ...
               <a class="navbar-brand" href="index.php"><img src="images/logo-landscape.png" alt="ftmgc" /></a>
            </div>
               ...
               <ul class="nav nav-pills navbar-nav<?php echo ($currentPage != 'index') ? ' no-dash' : '' ?>">
                  ...
                  <li class="<?php echo ($currentPage == 'settings') ? 'active ' : '' ?>dropdown">
                     <a href="#" class="dropdown-toggle"><i class="icon icon-settingsthree-gears mobile-icon"></i> Tools <b class="caret"></b></a>
                        ...
                        <?php } ?>
                        <li><a href="settings.php"><i class="icon icon-settingsandroid"></i> ftmgc Settings</a></li>
                  ...
                  <li class="<?php echo ($currentPage == 'help') ? 'active ' : '' ?>dropdown topnav">
                     ...
                     <ul class="dropdown-menu">
                        ...
                        <li><a href="https://play.google.com/store/apps/details?id=com.scar45.ftmgc" rel="external"><i class="icon icon-playstore"></i> Android Companion App</a></li>
                        <li><a href="https://github.com/ftmgc/ftmgc-web-app" rel="external"><i class="icon icon-github"></i> Source on Github</a></li>
                        <li><a href="http://ftmgc.info" rel="external"><i class="icon icon-glasses"></i> ftmgc Homepage</a></li>
                     </ul>
                  </li>
