...
?>
      ...
      <div id="dashboard-wrap" class="container sub-nav login-container">
         ...
         <div id="overview" class="panel panel-primary panel-no-grid panel-overview">
            ...
            <div class="panel-footer">
               ...
               <hr>
               <p><span>Still having trouble? Touch base with us on &nbsp;<a href="https://plus.google.com/u/0/b/110896112995796953409/communities/111042089628113521779" rel="external"><i class="icon icon-googleplus"></i></a> <a href="http://reddit.com/r/ftmgc" rel="external"><i class="icon icon-reddit"></i></a> <a href="http://twitter.com/ftmgc" rel="external"><i class="icon icon-twitter"></i></a> or <a href="http://webchat.freenode.net/?channels=%23ftmgc&uio=OT10cnVlJjExPTIwNQa5" rel="external">join our IRC chat</a>.</span></p>
            </div>
         </div>
      </div>
      <!-- /container -->
      ...
      <script type="text/javascript">
          ...
          function showToastFirstLogin() {
            var toastMsgFirstLogin = '<b>Read Carefully!</b><br />This is your first time logging into ftmgc. Please set a new username + password that will serve as your credentials.';
