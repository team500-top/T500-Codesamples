<?php
//
// Author: ftmgcMCS (ftmgc)
//
// Description: This is a quick tool to get basic information from a specified API for mining software.
// The goal is to expand ftmgc to as many devices as possible and make this open to all crypto miners.
//
...
<html>
    ...
    <body>
        ...
        <div style="font-size: 12px;margin-top:20px;"><a href="javascript:window.history.go(-1);">&#171; Back to ftmgc</a>.</div>
<?php
...
?>
        <hr />
        <div style="font-size: 12px;margin-top:20px;">This tool was created for <a href="http://ftmgc.info">ftmgc</a>.</div>
    </body>
</html>
