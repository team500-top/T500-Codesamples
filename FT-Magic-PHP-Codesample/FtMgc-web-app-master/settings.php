...
if (isset($_POST) && !empty($_POST)) {
    ...
    $generalSaveResult = $ftmgc->saveSettings(array('general' => $data));
    $ftmgc = new ftmgc();
                ...
                <div id="appUpdates">
                    ...
                    <div class="form-group">
                      <div class="checkbox">
                        ...
                        <label for="enableUpdates">Enable ftmgc Updates</label>
                      </div>
                    </div>
          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form">
              <fieldset>
                <div class="form-group">
                  <div class="col-sm-12">
                    <span class="help-block"><i class="icon icon-info-sign"></i> ftmgc cookies save preferences like panel width/positioning, and are safe to clear. Your important settings are always within the /user_data folder.<br><br><b>* YOU WILL BE LOGGED OUT AFTER CLEARING COOKIES!</b></span>
